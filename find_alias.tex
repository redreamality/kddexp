...
We first specify the relationship between them. Actually, they have the following relationship:
...
\begin{definition}[Definition of $JD(c_1,c_2)$]
  ...
  $$ JD(c_1,c_2) = \frac{1}{Z_\theta}\times e^{- \frac{1}{f(c_1)\times f(c_2)\times g(c_1,c_2))}}$$, where $f(c_i)=\frac{\sum{ P(c_i|e^*) }},(i=1,2)$ denotes the importance of a concept itself, $g({c_h}_1 ,{c_h}_2 )=\sum_{  (e_{1i},a,e_{2j})\in KB }P({c_h}_{1}|e_{1i}) \times P({c_h}_{2}|e_{2j})$ denotes the joint ratio of the concepts.
